...
#'   \item \code{value_label}: Formatted population with commas (e.g., "1,400,000,000")
#' }
#'
#' @details
...
#'
#' @export
get_india_population <- function() {
  url <- "https://api.worldbank.org/v2/country/IND/indicator/SP.POP.TOTL?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
