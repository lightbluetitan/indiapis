...
#'   \item \code{value}: Energy use per capita (in kg of oil equivalent)
#' }
#'
#' @details
...
#'
#' @export
get_india_energy_use <- function() {
  url <- "https://api.worldbank.org/v2/country/IND/indicator/EG.USE.PCAP.KG.OE?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
