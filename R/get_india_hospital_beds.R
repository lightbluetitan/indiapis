...
#'   \item \code{value}: Number of hospital beds per 1,000 people (numeric)
#' }
#'
#' @details
...
#'
#' @export
get_india_hospital_beds <- function() {
  url <- "https://api.worldbank.org/v2/country/IND/indicator/SH.MED.BEDS.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
