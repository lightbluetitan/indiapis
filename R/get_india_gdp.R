...
#'
#' @export
get_india_gdp <- function() {
  url <- "https://api.worldbank.org/v2/country/IND/indicator/NY.GDP.MKTP.CD?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
  ...
  df$value_label <- scales::comma(df$value)
  return(df)
}
